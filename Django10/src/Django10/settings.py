...
SOCIAL_AUTH_GOOGLE_OAUTH2_KEY = '330256653381-j0ckcet2om5fg968ps3i0p4hqt3rpbdc.apps.googleusercontent.com'
SCOIAL_AUTH_GOOGLE_OAUTH2_SECRET = 'Wy7cvTKIVOmWTD20u2krCZqP'
...
#http://127.0.0.1:8000/files/ 로 시작하는 경ㄹ는 미디어파일을 불러오는 것으로 판단
MEDIA_URL = '/files/'
